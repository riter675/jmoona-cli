...
def main():
    ...
    parser.add_argument("-t", "--type", choices=["movie", "tv", "multi"], default="multi", help="Type de contenu")
    parser.add_argument("-s", "--season", type=int, help="Numéro de saison")
    parser.add_argument("-e", "--episode", type=int, help="Numéro d'épisode")
    parser.add_argument("-q", "--quality", choices=["best", "1080p", "720p", "480p", "4k"], default="best", help="Qualité vidéo")
    parser.add_argument("-l", "--lang", help="Langue audio souhaitée")
    parser.add_argument("--sub", help="Langue sous-titres")
    parser.add_argument("-p", "--player", default="mpv", help="Lecteur vidéo")
